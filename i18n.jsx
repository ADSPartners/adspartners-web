...
const DICT = {
  es: {
    ...
    'mani.p1': 'adsPartners es un Creative Growth Studio para negocios ambiciosos. Entramos a ordenar el caos y construir el sistema lleve a las marcas del movimiento al crecimiento.',
    ...
    'work.wf.2.desc': 'Definimos la arquitectura. Público, ángulo de captación, oferta de entrada, embudo, canales, presupuesto, KPIs. El recorrido desde el primer impacto hasta el cierre, planificado antes de gastar una moneda.',
    ...
    'win.col.l': '1.000€ para construir el sistema.',
    'win.col.r': 'Variable para hacerlo crecer.',
    'win.note': 'El fee inicial (sin IVA incluido)* cubre la construcción completa antes del lanzamiento. <br> Dos semanas desde el kickoff hasta campañas en vivo. <br><br> Después del lanzamiento, pasamos a un modelo variable. Un porcentaje del crecimiento por encima de tu baseline actual. <br> Hablado contigo, no impuesto.',
  ...
  en: {
    ...
    'work.wf.2.desc': 'We define the architecture. Audience, acquisition angle, offer of entry, funnel, channels, budget, KPIs. The path from first impression to closed sale, planned before spending a coin.',
    ...
    'win.col.l': '€1,000 to build the system.',
    'win.col.r': 'Variable to grow it.',
    'win.note': 'The initial fee (VAT not included)* covers the full build before launch. <br> Two weeks from kickoff to live campaigns. <br><br> After launch, we move to a variable model. A percentage of growth above your current baseline. <br>Talked through with you, not imposed.',
