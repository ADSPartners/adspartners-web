...
const DICT = {
  es: {
    ...
    'mani.p1': 'adsPartners es un Growth Studio que trabaja con las marcas que de verdad están dispuestas a crecer. Entramos a ordenar el caos y construir algo que tenga sentido a largo plazo.',
    'mani.p2': 'No solo ejecutamos, y nunca hacemos servicios aislados. Trabajamos captación, conversión y dirección de marca como un sistema conectado.',
  ...
  en: {
    ...
    'mani.p1': 'adsPartners is a Growth Studio working with brands that are genuinely ready to grow. We come in to fix the chaos and build something that makes sense long term.',
    'mani.p2': 'We don\'t just execute, and we never do isolated services. We work acquisition, conversion and brand direction as one connected system.',
    'mani.aside.h': '(creative) Growth Studio',
